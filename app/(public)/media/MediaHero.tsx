  ...
  return (
    <section className="relative pt-40 pb-20 bg-bg-base overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          Healthcare Media{" "}
          <span className="text-gradient">That Communicates</span>{" "}
          with Precision
        </motion.h1>
        <motion.p
          initial={{ opacity: 0, y: 20 }}
        ...
        >
          Specialized media solutions tailored for healthcare professionals,
          medical institutions, and scientific events — produced to professional
          broadcast standards.
        </motion.p>
      </div>
    </section>
