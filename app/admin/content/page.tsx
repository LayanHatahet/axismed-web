      ...
      <AdminHeader
        ...
        action={
          <button
            onClick={save}
            disabled={saving}
            className="flex items-center gap-2 bg-purple-500 hover:bg-purple-400 disabled:opacity-60 text-white font-semibold px-5 py-2.5 rounded-xl transition-all shadow-[0_0_20px_rgba(164,158,207,0.4)]"
          >
