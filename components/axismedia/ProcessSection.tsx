  ...
  return (
    <section ref={ref} id="process" className="axm-frame relative py-20 lg:py-28">
      ...
      <div className="mx-auto max-w-[1500px] px-5 sm:px-8">
        <p className="axm-mono mb-4">/ 04 — standard operating procedure</p>
        ...
        <div className="relative mt-16 lg:mt-24">
          ...
          <div className="absolute bottom-0 left-[11px] top-0 w-px bg-[var(--axm-line)] lg:left-1/2" aria-hidden="true">
            <motion.div
              style={{ scaleY: fill }}
              className="h-full w-full origin-top bg-[var(--axm-green)] shadow-[0_0_14px_rgba(44,255,192,0.7)]"
            />
          </div>
              ...
              return (
                <li key={s.phase} className="relative lg:grid lg:grid-cols-2 lg:gap-20">
                  ...
                  <motion.span
                    ...
                    className="absolute left-[5px] top-1.5 h-3.5 w-3.5 rounded-full border-2 border-[var(--axm-green)] bg-[var(--axm-bg)] shadow-[0_0_16px_rgba(44,255,192,0.8)] lg:left-1/2 lg:-translate-x-1/2"
                  />
                  <motion.div
                  ...
                  >
                    ...
                    <p className="mt-1 text-sm font-medium text-[var(--axm-green)]">{s.tag}</p>
