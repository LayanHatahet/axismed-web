...
const MOBILE_BRANCHES = [
  { color: "#bcb8df", paramT: 0.33, tx: -1.1, ty:  1.1, tz: 0 },
  { color: "#b0accf", paramT: 0.67, tx:  1.1, ty:  1.1, tz: 0 },
...
const MOBILE_BRANCH_LABELS = [
  { label: "Courses", href: "/courses", pos: [-1.1,  1.1, 0] as [number,number,number] },
  { label: "Media",   href: "/media",   pos: [ 1.1,  1.1, 0] as [number,number,number] },
