...
const RIB_W    = 0.30;
const RIB_T    = 0.052;
const DRAW_SEC = 3.5;   // faster logo draw-in (was 9.2 → 5.0 → 3.5)
const BRANCH_S = 1.2;   // faster branch draw
const B_SEG    = 90;
const INTRO_SPEED = 2.4; // speeds up the camera / scale / glow choreography to match
