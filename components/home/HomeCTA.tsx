      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <SectionReveal delay={0.2}>
          <div className="flex items-center justify-center">
            <Link
              href="/contact"
              className="group inline-flex items-center gap-2 bg-purple-500 hover:bg-purple-400 text-white font-semibold px-8 py-4 rounded-xl transition-all shadow-[0_0_30px_rgba(124,58,237,0.5)] hover:shadow-[0_0_44px_rgba(124,58,237,0.7)] text-base"
            >
