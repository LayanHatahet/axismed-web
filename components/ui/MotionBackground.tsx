...
export function MotionBackground({
  ...
  const blobs = useMemo(() => {
    if (variant === "subtle") return [
      { left: "10%",  top: "15%",  w: 480, h: 380, blur: 130, color: "rgba(124,58,237,0.07)",  dur: 22, delay: 0,  br: ["60% 40% 30% 70%/60% 30% 70% 40%", "30% 60% 70% 40%/50% 60% 30% 60%", "60% 40% 30% 70%/60% 30% 70% 40%"] },
    ...
    if (variant === "deep") return [
      { left: "-5%",  top: "5%",   w: 700, h: 560, blur: 140, color: "rgba(124,58,237,0.14)",  dur: 19, delay: 0,  br: ["60% 40% 30% 70%/60% 30% 70% 40%", "30% 60% 70% 40%/50% 60% 30% 60%", "50% 50% 50% 50%/50% 50% 50% 50%", "60% 40% 30% 70%/60% 30% 70% 40%"] },
    ...
    if (variant === "hero") return [
      { left: "-10%", top: "-8%",  w: 800, h: 640, blur: 150, color: "rgba(124,58,237,0.13)",  dur: 16, delay: 0,  br: ["60% 40% 30% 70%/60% 30% 70% 40%", "30% 60% 70% 40%/50% 60% 30% 60%", "50% 50% 50% 50%/50% 50% 50% 50%", "60% 40% 30% 70%/60% 30% 70% 40%"] },
      ...
      { left: "18%",  top: "65%",  w: 460, h: 400, blur: 100, color: "rgba(109,40,217,0.11)",  dur: 20, delay: 3,  br: ["30% 70% 50% 50%/50% 30% 70% 50%", "60% 40% 60% 40%/40% 60% 40% 60%", "30% 70% 50% 50%/50% 30% 70% 50%"] },
    ];
    // purple (default)
    return [
      { left: "-8%",  top: "-5%",  w: 700, h: 560, blur: 140, color: "rgba(124,58,237,0.11)",  dur: 18, delay: 0,  br: ["60% 40% 30% 70%/60% 30% 70% 40%", "30% 60% 70% 40%/50% 60% 30% 60%", "50% 40% 60% 40%/40% 50% 60% 50%", "60% 40% 30% 70%/60% 30% 70% 40%"] },
      ...
      { left: "20%",  top: "68%",  w: 420, h: 360, blur: 100, color: "rgba(109,40,217,0.10)",  dur: 22, delay: 2,  br: ["30% 70% 50% 50%/50% 30% 70% 50%", "60% 40% 60% 40%/40% 60% 40% 60%", "30% 70% 50% 50%/50% 30% 70% 50%"] },
    ];
  }, [variant]);
      ...
      {variant === "hero" && !reduced && (
        <>
          ...
          <motion.div
            ...
            style={{
              background: "linear-gradient(245deg, transparent 35%, rgba(124,58,237,0.05) 55%, transparent 75%)",
            }}
          />
        </>
      )}
